...
const translations = {
    ...
    'timetable.friday.arrival': 'Saapuminen majoituksiin',
    'timetable.friday.sitsit': 'Sodan\xadjulistus\xadsitsit',
    'timetable.friday.declaration': 'Sodan\xadjulistus',
    'timetable.friday.afterparty': 'Sitsijatkot',
    'timetable.friday.sleep': 'Yöunille',
    'timetable.saturday': 'Lauantai 14.3.',
    'timetable.saturday.wakeup': 'Herätys',
    'timetable.saturday.breakfast': 'Aamiainen',
    'timetable.saturday.game1': 'Laji 1',
    'timetable.saturday.lunch': 'Lounas',
    'timetable.saturday.game2': 'Laji 2 feat. Junction',
    'timetable.saturday.game3': 'Laji 3',
    'timetable.saturday.game4': 'Laji 4',
    'timetable.saturday.game5': 'Päälaji',
    'timetable.saturday.results': 'Tulosten julkistus',
    'timetable.saturday.afterparty': 'Eeppiset Titeenijatkot',
    'timetable.saturday.sleep': 'Yöunille',
    ...
    'locations.ok20': 'Otakaari 20',
    'locations.tietotekniikantalo': 'Tietotekniikantalo',
    'locations.tf': 'Täffä',
    'locations.u2': 'U2-sali',
    'locations.alvari': 'Alvarin aukio',
    'locations.tip': 'Otaniemen kärki',
    'locations.bmk': 'BMK',
    ...
    'safety.guidelines.5': 'Epäasiallisesta käytöksestä pyydetään ilmoittamaan viipymättä häirintä\u00ADyhdys\u00ADhenkilölle, järjestäjälle tai Tietokillan [LINK:reportForm]anonyymiin häirintätilanteiden ilmoituslomakkeeseen[/LINK].',
    ...
    'safety.ifEncounterTitle': 'Häirintä\u00ADtilanteen kohdatessasi',
    'safety.ifEncounter': 'Ota yhteyttä Titeeneillä päivystäviin häirintä\u00ADyhdys\u00ADhenkilöihin, tapahtuman järjestäjiin tai jätä häirintä\u00ADyhdys\u00ADhenkilöille viesti Tietokillan [LINK:reportForm]anonyymiin ilmoituslomakkeeseen[/LINK]. Häirintä\u00ADyhdys\u00ADhenkilöiden yhteystiedot löydät tämän sivun alusta, tapahtumatilojen seiniltä ja vessoista, sekä Titeenien Telegram-tiedotuksesta.\n\nHäirintä\u00ADyhdys\u00ADhenkilöihin voi ottaa yhteyttä erittäin matalalla kynnyksellä ja häirintätilanteista voi ilmoittaa myös anonyymisti tai toisen henkilön puolesta.',
    
    'safety.hcpTitle': 'Häirintä\u00ADyhdys\u00ADhenkilöt',
    'safety.hcp': 'Titeeneillä päivystää häirintä\u00ADyhdys\u00ADhenkilöitä. Häryihin voivat olla yhteydessä kaikki osallistujat, vapaaehtoiset ja esiintyjät matalalla kynnyksellä.\n\nTietokillan häirintä\u00ADyhdys\u00ADhenkilöt ovat aina alkoholittomia. Heidän tehtävänä on olla puolueettomana tukijana kaikille, jotka ovat kokeneet minkäänlaista syrjintää, häirintää, ahdistelua tai epäasiallista kohtelua.\n\nTietokillan häirintä\u00ADyhdys\u00ADhenkilöt tunnistaa pinkeistä huomioliiveistä.\n\nTiteeneiden häirintä\u00ADyhdys\u00ADhenkilöinä toimivat Tietokillan vapaaehtoiset, jotka ovat käyneet AYY:n häirintä\u00ADyhdys\u00ADhenkilö\u00ADkoulutuksen ja toimineet häryinä killan tapahtumissa aiemminkin.\n\nHäirintätilanteet pyritään hoitamaan ensisijaisesti ratkaisukeskeisesti ja tarvittaessa osapuolet voidaan ohjata saamaan apua sopivan tuen piiriin. Häirintä\u00ADyhdys\u00ADhenkilö voi myös auttaa tilanteiden selvittelyssä yhdessä muiden tapahtuman häirintä\u00ADyhdys\u00ADhenkilöiden ja järjestäjien kanssa.\n\nFyysinen ja psyykkinen koskemattomuus on kaikkien oikeus ja Titeeneillä täytyy voida saada tuntea olonsa turvalliseksi ilman pelkoa minkäänlaisesta syrjinnästä tai häirinnästä, seksuaalisesta tai verbaalisesta ahdistelusta tai muutoin epäasiallisesta kohtelusta ja käytöksestä.',
  ...
  en: {
    ...
    'timetable.friday.arrival': 'Arrival to accommodation',
    'timetable.friday.sitsit': 'Declaration of War Sitsit',
    'timetable.friday.declaration': 'Declaration of War',
    'timetable.friday.afterparty': 'Sitsi afterparty',
    'timetable.friday.sleep': 'Sleep',
    'timetable.saturday': 'Saturday 14.3.',
    'timetable.saturday.wakeup': 'Wakeup',
    'timetable.saturday.breakfast': 'Breakfast',
    'timetable.saturday.game1': 'Event 1',
    'timetable.saturday.lunch': 'Lunch',
    'timetable.saturday.game2': 'Event 2 feat. Junction',
    'timetable.saturday.game3': 'Event 3',
    'timetable.saturday.game4': 'Event 4',
    'timetable.saturday.game5': 'Main event',
    'timetable.saturday.results': 'Results',
    'timetable.saturday.afterparty': 'Epic Titens Afterparty',
    'timetable.saturday.sleep': 'Sleep',
    'timetable.sunday': 'Sunday 15.3.',
    'timetable.sunday.wakeup': 'Wakeup',
    'timetable.sunday.breakfast': 'Breakfast',
    'timetable.sunday.leaving': 'Goodbyes :(',
    ...
    'locations.tf': 'Täffä',
    'locations.bmk': 'BMK',
    'locations.u2': 'Lecture hall U2',
    'locations.alvari': 'Alvari square',
    'locations.tip': 'Tip of Otaniemi',
    ...
    'safety.actionTitle': 'Act accordingly',
